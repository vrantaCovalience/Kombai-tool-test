      ...
      <div className="container">
        <div className="flex flex-col gap-xl">
          ...
          <div className="text-center flex flex-col gap-sm">
            ...
            <p className="text-secondary" style={{ lineHeight: '24px', maxWidth: '628px', margin: '0 auto' }}>
          ...
          {/* Blog Cards */}
          <div className="grid grid-cols-3 gap-lg blog-grid">
              ...
              <div key={index} className="card-blog">
                ...
                <div className="card-blog-content">
                  <div className="flex flex-col gap-sm">
                    <h3 className="heading-md text-secondary" style={{ lineHeight: '28px' }}>
                      {post.title}
                    </h3>
                    <div className="flex items-center gap-xs">
                      <span className="text-primary-color heading-md">Readmore</span>
